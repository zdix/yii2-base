<?php
namespace dix\base\module\generator\command;
...
{
    /**
     * @var \dix\base\module\generator\command\Generator
     */
    public $generator;
    /**
     * @var \dix\base\module\generator\controller\GenerateController
     */
    public $controller;

    /**
     * code will be generated to controller
     * @internal param int $v
     */
    public function run()
    {
        echo "\nRunning '{$this->generator->getName()}'...\n\n";
